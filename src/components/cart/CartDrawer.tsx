...
export function CartDrawer({ emp }: { emp: CartEmp }) {
  ...
  function confirmarTransferencia() {
    ...
    const msg = [
      `Hola! Te hago un pedido desde Viko 🛍️`,
      ``,
      `📦 *Detalle del pedido:*`,
      ...lineas,
      ``,
      ...
      `Nombre: ${nombre}`,
      `Teléfono: ${telefono}`,
      emp.envios && direccion ? `📍 Dirección de entrega: ${direccion}` : "",
      notas ? `📝 Notas: ${notas}` : "",
      ``,
      `Te envío el comprobante ahora. ¡Gracias! 🙌`,
    ]
      .filter((l) => l !== "")
      .join("\n");
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              <div>
                ...
                <input
                  ...
                  style={{
                    ...inputStyle,
                    borderColor: errores.nombre ? "#C4664A" : "#E8E4DC",
                  }}
                />
                {errores.nombre && (
                  <p style={{ fontSize: 11, color: "#C4664A", marginTop: 4 }}>
                    {errores.nombre}
                  </p>
                )}
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    setErrores((prev) => ({
                      ...prev,
                      telefono: validarTelefono(val),
                    }));
                  }}
                  onBlur={(e) =>
                    setErrores((prev) => ({
                      ...prev,
                      telefono: validarTelefono(e.target.value),
                    }))
                  }
                  ...
                  style={{
                    ...inputStyle,
                    borderColor: errores.telefono ? "#C4664A" : "#E8E4DC",
                  }}
                />
                {errores.telefono && (
                  <p style={{ fontSize: 11, color: "#C4664A", marginTop: 4 }}>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      setErrores((prev) => ({
                        ...prev,
                        direccion: validarDireccion(e.target.value),
                      }));
                    }}
                    onBlur={(e) =>
                      setErrores((prev) => ({
                    ...
                    style={{
                      ...inputStyle,
                      borderColor: errores.direccion ? "#C4664A" : "#E8E4DC",
                    }}
                  />
                  {errores.direccion && (
                    <p style={{ fontSize: 11, color: "#C4664A", marginTop: 4 }}>
        ...
        {showTransModal && (
          ...
          >
            ...
            >
              ...
              <p style={{ fontSize: 13, color: "#8A8680", marginBottom: 20 }}>
                Realizá la transferencia por el monto indicado y luego avisanos
                por WhatsApp con el comprobante.
              </p>
              <div
                style={{
                  background: "#F5F2EC",
