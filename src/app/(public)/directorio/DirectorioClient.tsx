...
export default function DirectorioClient({
  ...
  return (
    <div className={styles.page}>
      ...
      {/* COMO FUNCIONA */}
      <section style={{ background: "var(--white)", padding: "72px 5vw" }}>
        <div style={{ maxWidth: 960, margin: "0 auto" }}>
          ...
          >
            Para compradores y emprendedores
          </h2>
              ...
              {[
                {
                  icon: "🔍",
                  t: "Directorio curado",
                  s: "Encontrá emprendimientos por rubro y zona",
                },
                {
                  icon: "💳",
                  t: "Pagos seguros",
                  s: "MercadoPago, transferencia o efectivo",
                },
                {
                  icon: "🛒",
                  t: "Carrito de compras",
                  s: "Pedí varios productos en un solo lugar",
                },
                {
                  icon: "💬",
                  t: "Contacto directo",
                  s: "WhatsApp e Instagram sin intermediarios",
                },
                {
                  icon: "🚚",
                  t: "Envíos o retiro",
                  s: "Filtrá por emprendimientos con envío al país",
                },
              ].map(({ icon, t, s }) => (
                <div
                  key={t}
            ...
            >
              ...
              {[
                ...
                },
                {
                  ...
                  s: "Cargá y gestioná tus productos con fotos",
                },
                {
                  icon: "💳",
                  t: "Cobros integrados",
                  s: "MercadoPago, transferencia y efectivo",
                },
                {
                  icon: "📦",
                  t: "Gestión de pedidos",
                  s: "Seguimiento de pedidos en tiempo real",
                },
                {
                  icon: "📊",
                  t: "Métricas reales ⭐ Pro",
                  s: "Visitas, conversiones y rendimiento",
                },
                {
                  icon: "📱",
                  t: "QR descargable ⭐ Pro",
                  s: "Usalo en redes, packaging y eventos",
                },
              ].map(({ icon, t, s }) => (
                <div
                  key={t}
                ...
                >
                  ...
                  <div>
                    ...
                    <p style={{ fontSize: 13, color: "#8BB4E0", margin: 0 }}>
                      {s}
                    </p>
                  </div>
                </div>
          ...
          >
            {[
              ...
              { n: "5 min", l: "para publicar tu perfil" },
              { n: "100%", l: "argentino" },
              { n: "SSL", l: "sitio seguro" },
            ].map(({ n, l }, i) => (
              <div
                key={l}
                style={{
                  ...
                  textAlign: "center",
                  padding: "24px 16px",
                  borderRight: i < 3 ? "1px solid rgba(26,24,20,0.1)" : "none",
                }}
              >
                <p
                  style={{
